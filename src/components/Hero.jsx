    ...
    <section id='home' className='min-h-screen flex py-10 md:flex-row flex-col items-center' data-aos="fade-right">
        ...
        <div className='flex-1'>
          <div className='md:text-left text-center mt-5'>
              ...
              <a href='https://drive.google.com/file/d/1Vpeb8_sK-fQeqPhwoaivR-qzxlEN2x1u/view?usp=share_link' target={'_blank'}><button className='btn-primary mt-4'>Download Resume</button></a>
